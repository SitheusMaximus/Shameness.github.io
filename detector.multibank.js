...
import { CAPTURE_B_GLYPH_TEMPLATES } from './reference-glyphs-b.js';
...
const TEMPLATE_FEATURES = Object.freeze(Object.fromEntries(
  TYPE_NAMES.map((name) => [name, [
    ...GLYPH_TEMPLATES[name].map((encoded) => decodeBase64(encoded, Int8Array)),
    ...CAPTURE_B_GLYPH_TEMPLATES[name].map((encoded) => decodeBase64(encoded, Int8Array)),
  ]]),
));
